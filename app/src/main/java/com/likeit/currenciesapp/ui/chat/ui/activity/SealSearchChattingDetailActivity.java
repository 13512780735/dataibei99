...
public class SealSearchChattingDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seal_search_chatting_detail);
    ...
    private class ChattingRecordsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, viewHolder.portraitImageView, MyApplication.getOptions());
