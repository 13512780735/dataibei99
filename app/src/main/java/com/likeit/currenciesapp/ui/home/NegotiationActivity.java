...
public class NegotiationActivity extends Container implements PullToRefreshBase.OnRefreshListener2<ScrollView> {
    ...
    private OperateTypes operateType = OperateTypes.OTHER;
