...
import com.likeit.currenciesapp.ui.chat.db.Groups;
import com.likeit.currenciesapp.ui.chat.db.GroupsDao;
import com.likeit.currenciesapp.ui.chat.model.SealSearchConversationResult;
...
import com.likeit.currenciesapp.ui.chat.server.utils.OperationRong;
...
import com.likeit.currenciesapp.ui.chat.server.utils.photo.PhotoUtils;
import com.likeit.currenciesapp.ui.chat.server.widget.BottomMenuDialog;
...
import com.likeit.currenciesapp.ui.chat.ui.widget.DemoGridView;
import com.likeit.currenciesapp.ui.chat.ui.widget.switchbutton.SwitchButton;
...
public class GroupDetailActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initGroupData() {
        ...
        ImageLoader.getInstance().displayImage(portraitUri, mGroupHeader, MyApplication.getOptions());
            ...
            switch (requestCode) {
                ...
                case UPDATE_GROUP_HEADER:
                    ...
                    if (response5.getCode() == 200) {
                        ImageLoader.getInstance().displayImage(imageUrl, mGroupHeader, MyApplication.getOptions());
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == getCount() - 1 && isCreated) {
                ...
                ImageLoader.getInstance().displayImage(portraitUri, iv_avatar, MyApplication.getOptions());
                iv_avatar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
