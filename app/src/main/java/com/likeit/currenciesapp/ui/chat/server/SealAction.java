...
import com.likeit.currenciesapp.ui.chat.server.request.AddGroupMemberRequest;
import com.likeit.currenciesapp.ui.chat.server.request.AddToBlackListRequest;
import com.likeit.currenciesapp.ui.chat.server.request.AgreeFriendsRequest;
import com.likeit.currenciesapp.ui.chat.server.request.ChangePasswordRequest;
import com.likeit.currenciesapp.ui.chat.server.request.CheckPhoneRequest;
import com.likeit.currenciesapp.ui.chat.server.request.CreateGroupRequest;
import com.likeit.currenciesapp.ui.chat.server.request.DeleteFriendRequest;
import com.likeit.currenciesapp.ui.chat.server.request.DeleteGroupMemberRequest;
import com.likeit.currenciesapp.ui.chat.server.request.DismissGroupRequest;
import com.likeit.currenciesapp.ui.chat.server.request.FriendInvitationRequest;
import com.likeit.currenciesapp.ui.chat.server.request.JoinGroupRequest;
import com.likeit.currenciesapp.ui.chat.server.request.LoginRequest;
import com.likeit.currenciesapp.ui.chat.server.request.QuitGroupRequest;
import com.likeit.currenciesapp.ui.chat.server.request.RegisterRequest;
import com.likeit.currenciesapp.ui.chat.server.request.RemoveFromBlacklistRequest;
import com.likeit.currenciesapp.ui.chat.server.request.RestPasswordRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SendCodeRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetFriendDisplayNameRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetGroupDisplayNameRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetGroupNameRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetGroupPortraitRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetNameRequest;
import com.likeit.currenciesapp.ui.chat.server.request.SetPortraitRequest;
import com.likeit.currenciesapp.ui.chat.server.request.VerifyCodeRequest;
import com.likeit.currenciesapp.ui.chat.server.response.AddGroupMemberResponse;
import com.likeit.currenciesapp.ui.chat.server.response.AddToBlackListResponse;
import com.likeit.currenciesapp.ui.chat.server.response.AgreeFriendsResponse;
import com.likeit.currenciesapp.ui.chat.server.response.ChangePasswordResponse;
import com.likeit.currenciesapp.ui.chat.server.response.CheckPhoneResponse;
import com.likeit.currenciesapp.ui.chat.server.response.CreateGroupResponse;
import com.likeit.currenciesapp.ui.chat.server.response.DefaultConversationResponse;
import com.likeit.currenciesapp.ui.chat.server.response.DeleteFriendResponse;
import com.likeit.currenciesapp.ui.chat.server.response.DeleteGroupMemberResponse;
import com.likeit.currenciesapp.ui.chat.server.response.DismissGroupResponse;
import com.likeit.currenciesapp.ui.chat.server.response.FriendInvitationResponse;
import com.likeit.currenciesapp.ui.chat.server.response.GetBlackListResponse;
import com.likeit.currenciesapp.ui.chat.server.response.GetFriendInfoByIDResponse;
import com.likeit.currenciesapp.ui.chat.server.response.GetGroupInfoResponse;
import com.likeit.currenciesapp.ui.chat.server.response.GetGroupMemberResponse;
import com.likeit.currenciesapp.ui.chat.server.response.GetGroupResponse;
...
import com.likeit.currenciesapp.ui.chat.server.response.GetUserInfosResponse;
import com.likeit.currenciesapp.ui.chat.server.response.JoinGroupResponse;
import com.likeit.currenciesapp.ui.chat.server.response.LoginResponse;
import com.likeit.currenciesapp.ui.chat.server.response.QiNiuTokenResponse;
import com.likeit.currenciesapp.ui.chat.server.response.QuitGroupResponse;
import com.likeit.currenciesapp.ui.chat.server.response.RegisterResponse;
import com.likeit.currenciesapp.ui.chat.server.response.RemoveFromBlackListResponse;
import com.likeit.currenciesapp.ui.chat.server.response.RestPasswordResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SendCodeResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetFriendDisplayNameResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetGroupDisplayNameResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetGroupNameResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetGroupPortraitResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetNameResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SetPortraitResponse;
import com.likeit.currenciesapp.ui.chat.server.response.SyncTotalDataResponse;
import com.likeit.currenciesapp.ui.chat.server.response.UserRelationshipResponse;
import com.likeit.currenciesapp.ui.chat.server.response.VerifyCodeResponse;
import com.likeit.currenciesapp.ui.chat.server.response.VersionResponse;
import com.likeit.currenciesapp.ui.chat.server.utils.NLog;
import com.likeit.currenciesapp.ui.chat.server.utils.json.JsonMananger;
    ...
    * */
    ...
    public LoginResponse login(String region, String phone, String password) throws HttpException {
        ...
        if (!TextUtils.isEmpty(result)) {
            ...
            Log.d("TAG","LoginResponse"+result);
