...
public class SellResultActivity extends Container {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.go_btn:
                ...
                bankDai = inputBankDaiEt.getText().toString().trim();
                ...
                tipsDialog.setOnClickListener(new TipsDialog.OnClickListener() {
                    ...
                    public void onLeftClick() {
                        if (modifyOrder) {
                            editOrder();
                            // toActivityFinish(OrderListActivity.class);
                        } else {
                            refer();
    ...
    private void refer() {
        ...
        params.put("tel", UtilPreference.getStringValue(this, "phone"));
        params.put("bz", bz);
        ...
        params.put("bank3", bankName);
        params.put("bank4", bankAccount);
        params.put("bank5", mUserBankInfo.getCity());
        params.put("bank6", mUserBankInfo.getZhname());
        params.put("bank11", "");
        params.put("bank12", "");
        params.put("pty", "");
        params.put("dt1", "");
