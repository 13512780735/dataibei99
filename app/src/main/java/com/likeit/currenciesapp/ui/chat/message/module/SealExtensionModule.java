package com.likeit.currenciesapp.ui.chat.message.module;
...
//            pluginModuleList.add(new RedPlugin(RongContext.getInstance()));
//            pluginModuleList.add(new TransferPlugin(RongContext.getInstance()));
            try {
