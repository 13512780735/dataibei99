...
import com.likeit.currenciesapp.ui.chat.ui.widget.ReadReceiptViewPager;
...
public class ReadReceiptDetailActivity extends BaseActivity {
    ...
    private void setTabSelectedBG(TextView vLine, TextView vText) {
        vLine.setBackgroundColor(getResources().getColor(R.color.headerbg));
        vLine.setHeight(6);
        vText.setTextColor(getResources().getColor(R.color.headerbg));
    }
