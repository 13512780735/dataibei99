...
public class SellActivity extends Container implements PullToRefreshBase.OnRefreshListener2<ScrollView> {
    ...
    private void initView() {
        ...
        tvHeader.setText(this.getResources().getString(R.string.currency_name19));
    ...
    private void initBuySellValue(Double inputNum) {
        ...
        if (ArithTool.sub(inputNum, rateInfoEntity.getSxf().getNomore()) >= 0) {
            ...
            if (operateType == OperateTypes.SELL) {
