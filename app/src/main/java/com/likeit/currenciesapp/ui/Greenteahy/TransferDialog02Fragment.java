 ...
 */
public class TransferDialog02Fragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_transfer_dialog02, container, false);
    ...
    private void refer(String result) {
        ...
        RequestParams params = new RequestParams();
        params.put("ukey", UtilPreference.getStringValue(getActivity(), "ukey"));
        params.put("transfer_user", transferAccountInfoEntity.getUser_name());
        params.put("dian", money);
        params.put("paypwd", result);
        params.put("shiming", name);
        params.put("remark", "");
