...
import com.likeit.currenciesapp.ui.chat.message.module.SealExtensionModule;
...
import com.likeit.currenciesapp.ui.chat.server.response.ContactNotificationMessageData;
...
public class SealAppContext implements RongIM.ConversationListBehaviorListener,
    ...
    private void initData(String id) {
        ...
        params.put("ukey", UtilPreference.getStringValue(getContext(), "ukey"));
      ...
      //  RxBus.get().post(new RefreshEvent(RefreshEvent.GET_NEW_MSG));
        ...
        if (messageContent instanceof ContactNotificationMessage) {
            ...
            if (contactNotificationMessage.getOperation().equals("Request")) {
                //对方发来好友邀请
               // initData(message.getSenderUserId());
                //initData(message.getSenderUserId());
